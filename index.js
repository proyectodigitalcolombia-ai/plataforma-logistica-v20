...
const css = `<style>
  ...
  .fs{height:12px;margin-bottom:5px}.fc{width:8500px;height:1px}
  table{border-collapse:collapse;min-width:8500px;font-size:10px}
  ...
  .td-estado{padding:0 !important;width:1px}
  .sel-est{background:#334155;color:#fff;border:none;padding:8px 4px;font-size:9px;width:100%;min-width:165px;cursor:pointer;text-align:center}
  .st-real{padding:4px 8px;border-radius:12px;font-weight:bold;font-size:9px;text-transform:uppercase}
  .st-desp{background:#065f46;color:#34d399}.st-pend{background:#475569;color:#cbd5e1}
  .td-obs{white-space:normal !important;min-width:300px;max-width:500px;text-align:left;line-height:1.2}
  .btn-fin{background:#10b981;color:white;padding:5px 8px;border-radius:4px;font-weight:bold;text-decoration:none;font-size:9px}
  .td-act{width:135px;min-width:135px;color:#fbbf24;font-weight:bold}
  /* Estilos de Alertas Actualizados */
